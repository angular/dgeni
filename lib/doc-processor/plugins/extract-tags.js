...
module.exports = function extractTagsPluginFactory(tagDefs) {
  return {
    name: 'extract-tags',
    each: function(doc) {
      ...
      _.forEach(tagDefs, function(tagDef) {
        ...
        // The function to transform the data from the tag to the doc
        var transform = tagDef.transformFn || function(doc, tag) { return tag[tagProperty]; };
        ...
        if ( tags.length === 0 ) {
          ...
          _.forEach(tags, function(tag) {
            ...
            doc[docProperty].push(transform(doc, tag));
          });
          ...
          doc[docProperty] = transform(doc,tags[0]);
        }
      });
    }
  };
