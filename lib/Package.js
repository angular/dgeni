...
Package.prototype.processor = function(processorFactory) {
  ...
  if (typeof processorFactory === 'object' ) {
    this.module.value(processorFactory.name, processorFactory);
  } else if (typeof processorFactory == 'function' ) {
    this.module.factory(processorFactory.name, processorFactory);
  } else {
    throw new Error('processorFactory must be an object or a function');
  }
