...
module.exports = function extractTagsFactory(tagParser, tagDefs) {
  ...
  return function(doc) {
    ...
    _.forEach(tagDefs, function(tagDef) {
      ...
      var tags = tagParser.getTags(doc.tags, tagDef.name);
      
      // Also collect tags using alias names
      _.forEach(tagDef.aliases, function(alias) {
        tags = tags.concat(tagParser.getTags(doc.tags, alias));
      });
