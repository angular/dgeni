...
module.exports = function docRendererFactory(templateFolder, outputFolder, templateFinderFactory, customFilters, customTags) {
  ...
  return function render(docs, extra) {
    ...
    _.forEach(docs, function(doc) {
      ...
      try {
        ...
        outputPath = path.resolve(outputFolder, doc.filePath);
