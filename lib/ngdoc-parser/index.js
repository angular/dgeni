  ...
  function processInlineTags(tagInfo) {
    ...
    _.forEach(blocks, function(block, index) {
      ...
      if(match) {
        ...
        _.forEach(inlineTagHandlers, function(handler) {
          var result = handler(tagInfo, inlineName, inlineContent);
          if ( !( _.isUndefined(result) || _.isString(result) || _.isFunction(result) ) ) {
          ...
          blocks[index] = result || blocks[index];
        });
      }
