 ...
 *
 * @description
 * Configures the mock implementation of {@link module:ng.$exceptionHandler} to rethrow or to log errors
 ...
 *
 * @description
 * Mock implementation of {@link module:ng.$exceptionHandler} that rethrows or logs errors passed
 * into it. See {@link $exceptionHandlerProvider $exceptionHandlerProvider} for configuration
 * information.
 *
 *
 * <pre>
...
angular.mock.$ExceptionHandlerProvider = function() {
   ...
   * @ngdoc method
   * @name mode
   * @memberof $exceptionHandlerProvider
   *
   * @description
   ...
   *            assertion of them. See {@link $log#assertEmpty assertEmpty()} and
   *            {@link $log#reset reset()}
   */
 ...
 *
 * @description
 * Mock implementation of {@link module:ng.$log} that gathers all logged messages in arrays
...
angular.mock.$LogProvider = function() {
  ...
  this.$get = function () {
    ...
    $log.reset = function () {
       ...
       *
       * @description
       * Array of messages logged using {@link $log#log}.
       *
       * @example
       * <pre>
       * $log.log('Some Log');
       ...
       *
       * @description
       * Array of messages logged using {@link $log#info}.
       *
       * @example
       * <pre>
       * $log.info('Some Info');
       ...
       *
       * @description
       * Array of messages logged using {@link $log#warn}.
       *
       * @example
       * <pre>
       ...
       *
       * @description
       * Array of messages logged using {@link $log#error}.
       *
       * @example
       * <pre>
       * $log.log('Some Error');
       ...
       *
       * @description
       * Array of messages logged using {@link $log#debug}.
       *
       * @example
       * <pre>
 ...
 *
 * Use {@link $interval#flush `$interval.flush(millis)`} to
 ...
 *   will invoke `fn` within the {@link module:ng.function:$rootScope.Scope#$apply $apply} block.
