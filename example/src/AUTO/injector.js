 ...
 * {@link $provide provider}, instantiate types, invoke methods,
 * and load modules.
 *
 ...
 *
 * When you request a service, the {@link $injector $injector} is responsible for finding the
 ...
 * For example, the {@link module:ng.$log $log} service has a provider called
 * {@link module:ng.$logProvider $logProvider}.
 *
 * Service provider objects can have additional methods which allow configuration of the provider
 * and its service. Importantly, you can configure what kind of service is created by the `$get`
 * method, or how that service will act. For example, the {@link module:ng.$logProvider $logProvider} has a
 * method {@link module:ng.$logProvider#debugEnabled debugEnabled}
 * which lets you specify whether the {@link module:ng.$log $log} service will log debug messages to the
 * console or not.
 *
 ...
 *               {@link $injector#invoke $injector.invoke()} when an instance needs to be
 *               created.
 *   - `Constructor`: a new instance of the provider will be created using
 *               {@link $injector#instantiate $injector.instantiate()}, then treated as
 *               `object`.
 *
 ...
 * You should use {@link $provide#factory $provide.factory(getFn)} if you do not need to
 ...
 *    the {@link $injector#invoke injector.invoke} method and is therefore fully injectable.
 ...
 *
 * @example
 * Here we decorate the {@link module:ng.$log $log} service to convert warnings to errors by intercepting
 * calls to {@link module:ng.$log#error $log.warn()}.
 * <pre>
