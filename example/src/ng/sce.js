 ...
 * @description
 *
 * `$sceDelegate` is a service that is used by the `$sce` service to provide {@link $sce Strict
 * Contextual Escaping (SCE)} services to AngularJS.
 *
 * Typically, you would configure or override the {@link $sceDelegate $sceDelegate} instead of
 * the `$sce` service to customize the way Strict Contextual Escaping works in AngularJS.  This is
 * because, while the `$sce` provides numerous shorthand methods, etc., you really only need to
 * override 3 core functions (`trustAs`, `getTrusted` and `valueOf`) to replace the way things
 * work because `$sce` delegates to `$sceDelegate` for these operations.
 *
 * Refer {@link $sceDelegateProvider $sceDelegateProvider} to configure this service.
 *
...
function $SceDelegateProvider() {
   ...
   *
   *     Follow {@link $sce#resourceUrlPatternItem this link} for a description of the items
  ...
  * @name resourceUrlBlacklist
  ...
  this.$get = ['$injector', function($injector) {
    ...
    * @name trustAs
     ...
     * See {@link $sce $sce} for enabling strict contextual escaping.
     *
 ...
 * @description
 *
 * The $sceProvider provider allows developers to configure the {@link $sce $sce} service.
 * -   enable/disable Strict Contextual Escaping (SCE) in a module
 * -   override the default implementation with a custom delegate
 *
 * Read more about {@link $sce Strict Contextual Escaping (SCE)}.
 */
 ...
 *
 * This applies both to the {@link directive:ngInclude `ng-include`} directive as well as
 ...
 * | Context             | Notes          |
 * |---------------------|----------------|
 * | `$sce.HTML`         | For HTML that's safe to source into the application.  The {@link directive:ngBindHtml ngBindHtml} directive uses this context for bindings. |
 ...
 *      http://docs.closure-library.googlecode.com/git/closure_goog_string_string.js.source.html#line962).
 *
 * Refer {@link $sceDelegateProvider $sceDelegateProvider} for an example.
 *
  ...
  * @name enabled
  ...
  this.$get = ['$parse', '$sniffer', '$sceDelegate', function(
    ...
    * @name isEnabled
     ...
     * have to do it at module config time on {@link $sceProvider $sceProvider}.
     *
     * @description
    ...
    * @name trustAs
     ...
     * that uses the provided value.  See * {@link $sce $sce} for enabling strict contextual
     * escaping.
     *
     * @param {string} type The kind of context in which this value is safe for use.  e.g. url,
