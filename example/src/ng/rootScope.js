...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
     ...
     *
     * @description
     * A root scope can be retrieved using the {@link module:ng.$rootScope $rootScope} key from the
     * {@link module:AUTO.$injector $injector}. Child scopes are created using the
     ...
     * @ngdoc property
     * @name $id
     * @propertyOf global:$rootScope.Scope
    ...
    Scope.prototype = {
       ...
       * @ngdoc method
       * @name $new
       * @methodOf global:$rootScope.Scope
       * @function
       *
       * @description
      ...
      * @name $digest
       ...
       * @ngdoc event
      * @name $destroy
       * @eventOf global:$rootScope.Scope
