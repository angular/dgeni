/**
 * @license AngularJS v1.2.9-build.local+sha.dde1b29
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.9-build.local+sha.dde1b29/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.9-build.local+sha.dde1b29',    // all of these placeholder strings will be replaced by grunt's
